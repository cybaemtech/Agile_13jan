...
export function EditItemModal({
  ...
  const onSubmit = async (data: WorkItemFormValues) => {
    ...
    try {
      ...
      // Add multiple assignees for Epic/Feature types
      if ((workItem.type === 'EPIC' || workItem.type === 'FEATURE') && multipleAssignees.length > 0) {
        (submitData as any).assignees = multipleAssignees;
        console.log("Adding multiple assignees to submit data:", multipleAssignees);
      }
